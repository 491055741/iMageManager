...
#define FFMPEG_CONFIGURATION "--enable-libx264 --enable-postproc --enable-gpl --enable-version3 --enable-nonfree --enable-shared --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-iconv --enable-protocol=async --extra-cflags=-I/Users/lipeng/workspace/ijkplayer-master/extra/ffmpeg/x264-iOS/include --extra-ldflags=-L/Users/lipeng/workspace/ijkplayer-master/extra/ffmpeg/x264-iOS/lib --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/lipeng/workspace/ijkplayer-master/ios/build/ffmpeg-arm64/output --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode '"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/lipeng/workspace/ijkplayer-master/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/lipeng/workspace/ijkplayer-master/ios/build/ffmpeg-arm64/output/share/ffmpeg"
